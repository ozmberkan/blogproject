...
const Banner = ({ blogs }) => {
  ...
  return (
    <div
      ...
      className="w-full bg-red-500 drop-shadow-2xl  h-[500px] p-7 bg-cover bg-center shadow-[inset_-0px_200px_400px_#05966970] rounded-xl flex flex-col gap-5 items-start justify-start "
    >
      <h1 className="font-semibold text-4xl text-white">{bannerBlog.title}</h1>
